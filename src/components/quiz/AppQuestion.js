    ...
    constructor(props) {
      ...
      setResults (result) {
        if (result.length === 1) {
          ...
          switch(true){
            case (this.state.result == "une grosse guidoune"):
            ...
            case (this.state.result == "un jeune bédouin"):
            ...
            case (this.state.result == "un chasseur de caribou"):
            ...
            case (this.state.result == "un maître-poutinier"):
            ...
            case (this.state.result == "un astrophysicien légendaire"):
                this.setState({ desc: "la sagesse est ton crédo, l'expérience ton arme de prédilection. Grâce à ton âge probablement canonique, tu es en mesure de connaître la vraie valeur des choses et de modérer tes actions afin de laisser la vie faire son travail. Tu te ferais même un petit plaisir à tuer tes adversaires à petit feu, avec leurs propres erreurs. Tu es la plus intangible et honorable des guidounes.", 
                                ...
                                famous: "Justin Bieber, Avril Lavigne, Emmanuel Macron"});
                break;
                
            case (this.state.result == "un consul montréalais"):
      ...
      renderResult() {
        return (
          <Result quizResult={this.state.result} desc={this.state.desc} famous={this.state.famous} statut={this.state.statut} />
        );
      }
