    ...
    constructor(props) {
      ...
      setNextQuestion() {
        ...
        this.setState({
          ...
          image: quizQuestions[counter].img,
      ...
      renderResult() {
        return (
          <Result quizResult={this.state.title} desc={this.state.desc} famous={this.state.famous} statut={this.state.statut} img={this.state.image}/>
        );
      }
