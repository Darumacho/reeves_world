    ...
    return (
      ...
      <div className="tabContainer">
        ...
        <MaterialTable
          ...
          data={[
              { name: 'Protosabre', icon: 'boy', damage: 16, grade: 1, coeff: 1.02, element: 0, effect: 'Aucun', port: 1 },
              { name: 'Katana', icon: 'boy', damage: 14, grade: 1, coeff: 1.02, element: 0, effect: 'Aucun', port: 1 },
              { name: 'Fleuret magique', icon: 'boy', damage: 17, grade: 1, coeff: 1.02, element: 0, effect: 'Aucun', port: 1 },
              { name: 'Fleuret du floret', icon: 'boy', damage: 19, grade: 2, coeff: 1.05, element: 0, effect: '+20% de chances de saignement', port: 1 },
              { name: 'Égéthère', icon: 'boy', damage: 60, grade: 5, coeff: 1.25, element: 10, effect: '+250EG', port: 1 },
              { name: 'Luminosabre écarlate', icon: 'boy', damage: 27, grade: 3, coeff: 1.08, element: 3, effect: '+10% de chances d\'électrocuter', port: 1 },
              { name: 'Duo électrofantastique', icon: 'boy', damage: 24, grade: 4, coeff: 1.12, element: 3, effect: '+25% de chances d\'électrocuter | frappe deux fois', port: 2 },
              { name: 'Blade on Fire', icon: 'boy', damage: 23, grade: 3, coeff: 1.08, element: 1, effect: '+10 de chances de brûler | + 50EG', port: 1 },
              { name: 'Katanaffamé', icon: 'boy', damage: 41, grade: 4, coeff: 1.12, element: 0, effect: 'restaure de la santé à chaque tour', port: 1 },
              { name: 'Fleuret magistral', icon: 'boy', damage: 48, grade: 7, coeff: 1.22, element: 0, effect: '20% de chances d\'éblouir la cible', port: 1 },
              { name: 'Épée longue', icon: 'boy', damage: 16, grade: 1, coeff: 1.02, element: 0, effect: 'Aucun', port: 1 },
              ...
              { name: 'Lame effilochée', icon: 'boy', damage: 38, grade: 5, coeff: 1.25, element: 7, effect: '-', port: 1},
              ]}
